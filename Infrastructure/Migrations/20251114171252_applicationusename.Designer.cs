...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251114171252_applicationusename")]
    partial class applicationusename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Director", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Interest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Movie", b =>
                {
                    ...
                    b.HasIndex("Title", "ReleaseYear", "DirectorId")
                        .IsUnique();

                    b.ToTable("Movies");
                });

            modelBuilder.Entity("Core.Domain.Entities.MovieActor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.MovieGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovieId", "VoteType");

                    b.HasIndex("UserId", "MovieId")
                        .IsUnique();

                    b.HasIndex("UserId", "VoteType");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Movie", b =>
                {
                    b.HasOne("Core.Domain.Entities.Director", "Director")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("Core.Domain.Entities.MovieActor", b =>
                {
                    b.HasOne("Core.Domain.Entities.Actor", "Actor")
