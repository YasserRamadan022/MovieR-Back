...
namespace Infrastructure.Migrations
{
    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Interests_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interests_UserId_MovieId",
                table: "Interests",
                columns: new[] { "UserId", "MovieId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movies_Title_ReleaseYear_DirectorId",
                table: "Movies",
                columns: new[] { "Title", "ReleaseYear", "DirectorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_MovieId_VoteType",
                table: "Votes",
                columns: new[] { "MovieId", "VoteType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserId_MovieId",
                table: "Votes",
                columns: new[] { "UserId", "MovieId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Votes_UserId_VoteType",
                table: "Votes",
                columns: new[] { "UserId", "VoteType" });
        }
